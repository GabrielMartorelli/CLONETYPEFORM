...
const Frist: React.FC = () => {
 
  const {scrollYProgress} = useViewportScroll()

  const fristScale = useTransform(scrollYProgress, 
    [0.198, 0.264 , 0.558, 0.627],
    [1, 0.511 , 0.511, 1]
    )
  
/*const fristRadius = useTransform(scrollYProgress, 
    [0.198, 0.264 , 0.558, 0.627],
    [0, 4 , 4, 0]
    );*/
...
const offsetY = useTransform(
  ...
  return (
    <Sticky className='frist'
    style={{
      scale: fristScale
      /*borderRadius: fristRadius*/
    }}>
